...
map.on('singleclick', function (evt) {
  ...
  var url = federacoes.getSource().getGetFeatureInfoUrl(evt.coordinate, resolution, 'EPSG:4326', {
    'INFO_FORMAT': 'application/json',
    'propertyName':  'NOME_UF',
    'FEATURE_COUNT': 50,
  });
  ...
  if(url) {
    $.getJSON(url, function (data) {
      ...
      content.innerHTML = '<p> UF: ' + result.properties.NOME_UF + '</p>';
